 ...
 *
 * 本文件编译到 out-test/test/runTest.js,故 __dirname = out-test/test:
 * - extensionDevelopmentPath = 项目根(含 package.json / dist)
 * - extensionTestsPath = out-test/test/integration/index.js
 */
